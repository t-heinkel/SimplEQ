...
struct PathProducer
{
    PathProducer(SingleChannelSampleFifo<SimplEQAudioProcessor::BlockType>& scsf) :
...
private:
    SingleChannelSampleFifo<SimplEQAudioProcessor::BlockType>* leftChannelFifo;
